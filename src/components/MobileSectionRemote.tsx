    ...
    >
      ...
      >
        <button
          ...
          disabled={atStart}
          aria-label="이전 섹션"
          className="flex h-10 w-10 items-center justify-center rounded-full text-white/70 transition-colors active:bg-white/10 disabled:pointer-events-none disabled:opacity-25"
        >
        ...
        <span className="min-w-[4.5rem] text-center text-[11px] tracking-[0.14em] text-white/35">
          {LABELS[index] ?? ""}
        </span>
